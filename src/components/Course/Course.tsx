...
const Course = (props: prop): JSX.Element => {
  ...
  return (
    <div className='flex flex-col w-60 h-96 bg-slate-200 dark:bg-slate-700 shadow-lg rounded-2xl overflow-hidden justify-self-center mx-auto'>
      <Link href={`/courses/${props.id}`} className="w-full h-full">
        ...
        <div className='px-2 pt-2'>
          ...
          <div className='flex justify-center '>
            <div
              className={`bg-green-500 flex justify-center items-center w-9 hover:w-full h-9 rounded-full transition-all ease-in-out duration-200 before:content-["⊻"] hover:before:content-none font-dana-medium hover:after:content-["بیشتر..."] `}
            ></div>
          </div>
        </div>
      </Link>
