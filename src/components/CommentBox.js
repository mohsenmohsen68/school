    ...
    return (
        <>
            {commentBody.length > 0 ? (
                <div className=''>
                    <div className='flex w-full font-dana pl-2 '>
                        ...
                        <div className='w-10/12 flex flex-col'>
                            <div className='flex justify-between items-center pl-4 '>
                                ...
                                <div>{new Intl.DateTimeFormat("fa-IR").format(commentBody[0].commentDate)}</div>
                ...
                <div className="flex justify-center items-center font-dana">
