"use client";
import { createANewRequest } from "@/Redux/request/Request";
...
function ContactusForm({ userID }) {
  ...
  return (
    <div className='flex flex-col gap-2 justify-center items-center p-4 shadow-lg mx-4 dark:shadow-md dark:bg-slate-800 dark:shadow-slate-500 '>
      <div className='font-dana text-sm'> فرم تماس با ما </div>
      <div className='font-dana text-xl'>
        برای تماس با ما فرم زیر را پر کنید ...
      </div>
      <div className='flex flex-col w-full justify-start px-2 font-dana'>
      ...
      <div className=' w-full flex justify-center'>
        <button
          className='w-full p-2 flex justify-center items-center bg-green-500 hover:bg-green-400 font-dana text-white font-bold mx-2'
